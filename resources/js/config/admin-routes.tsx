...
export const ADMIN_ROUTES: AdminRoute[] = [
    ...
    },
    {
        ...
        subs: [
            ...
            {
                id: "admin-curriculum-authority-codes",
                title: "Authority Codes",
                link: "/administrators/curriculum/authority-codes",
                requiredPermission: "ViewAny:IndustryCourseCode",
                allowedRoles: [
                    ...SYSTEM_ADMIN_ROLES,
                    UserRole.Dean,
                    UserRole.AssociateDean,
