...
Route::middleware(['auth', 'administrators.only'])
    ...
    ->group(function (): void {
        ...
        Route::post('/registrar/analytics/student-profile-imports', [AdministratorRegistrarInsightsController::class, 'storeStudentProfileImport'])
            ->middleware('throttle:10,1')
            ->name('registrar.analytics.student-profile-imports.store');
        Route::post('/registrar/analytics/student-profile-imports/{studentProfileImport}/confirm', [AdministratorRegistrarInsightsController::class, 'confirmStudentProfileImport'])
            ->middleware('throttle:10,1')
        ...
        Route::get('/curriculum/authority-codes', [AdministratorIndustryCodeController::class, 'index'])->name('curriculum.authority-codes.index');
        ...
        Route::delete('/curriculum/code-authorities/{codeAuthority}', [AdministratorIndustryCodeController::class, 'destroyAuthority'])->name('curriculum.code-authorities.destroy');
        ...
        Route::delete('/curriculum/authority-codes/{industryCourseCode}', [AdministratorIndustryCodeController::class, 'destroyCode'])->name('curriculum.authority-codes.destroy');
        ...
        Route::put('/system-management/schools/{school}/curriculum-capabilities', [App\Http\Controllers\AdministratorSystemManagementController::class, 'updateSchoolCurriculumCapabilities'])->name('system-management.schools.curriculum-capabilities.update');
