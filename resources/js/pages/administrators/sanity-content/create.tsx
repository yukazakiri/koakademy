...
interface CreateSanityContentProps {
    auth: {
        user: User;
    };
}
...
export default function AdministratorSanityContentCreate({ auth }: CreateSanityContentProps) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        priority: "normal",
        featured: false,
        featured_image: null as FeaturedImage | null,
        published_at: "",
        tags: "",
        audiences: "",
        channels: "",
    ...
    const submit = (e: React.FormEvent) => {
        ...
        post(route("administrators.sanity-content.store"), {
            ...
            onError: () => toast.error("Failed to create post. Please check the form."),
        });
    };
    ...
    return (
        <AdminLayout user={auth.user} title="Create Post">
