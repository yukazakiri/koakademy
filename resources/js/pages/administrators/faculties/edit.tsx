...
export default function AdministratorFacultyEdit({ user, faculty, options }: FacultyEditProps) {
    ...
    const [photoPreview, setPhotoPreview] = useState<string | null>(faculty.photo_url);
    ...
    const displayName = useMemo(() => {
        ...
        return parts.length ? parts.join(" ") : "Faculty";
    }, [data.first_name, data.last_name, data.middle_name]);

    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route("administrators.faculties.update", faculty.id), {
            forceFormData: true,
        });
    };
    ...
    return (
        <AdminLayout user={user} title="Edit Faculty">
            <Head title={`Administrators • Faculties • Edit • ${displayName}`} />
                ...
                <div className="lg:col-span-2">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p className="text-muted-foreground">Update information — changes save instantly to the directory.</p>
                        </div>
                    ...
                    <form onSubmit={submit} className="mt-4">
                            ...
                            <TabsContent value="basics" className="mt-4">
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>These are the most important fields for identification.</CardDescription>
                                    </CardHeader>
                                        ...
                                        <div className="space-y-2 sm:col-span-2">
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    setData("photo", file);
                                                    setPhotoPreview(file ? URL.createObjectURL(file) : faculty.photo_url);
                                                }}
                                            />
                            ...
                            <TabsContent value="notes" className="mt-4">
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>Background and teaching notes.</CardDescription>
                                    </CardHeader>
                        ...
                        <div className="mt-6 flex justify-end gap-3">
                            <Button variant="outline" asChild>
                                <Link href={route("administrators.faculties.show", faculty.id)}>Cancel</Link>
                            </Button>
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <div className="text-muted-foreground truncate text-sm">{data.email || "No email"}</div>
                                </div>
                                <Button
                                    type="button"
                                    variant="outline"
