...
export default function SystemManagementMailPage({ user, mail_config, access }: SystemManagementPageProps) {
    ...
    return (
        <SystemManagementLayout
            ...
            description="Review the runtime mail transport. Credentials are managed by the deployment operator."
        >
            <Card>
                <CardHeader>
                    <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-1">
                            ...
                            <CardDescription>KoAkademy never stores SMTP or provider credentials in the application database.</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="space-y-2 text-sm">
                                ...
                                <p className="text-muted-foreground">
                                    Configure SMTP or Sequenzy from the server, where credentials are rotated as Docker Secrets and FrankenPHP is
                                    restarted safely.
                                </p>
