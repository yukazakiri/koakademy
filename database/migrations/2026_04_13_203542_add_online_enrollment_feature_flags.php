...
return new class extends Migration
{
    ...
    {
        $tesda = OnboardingFeature::query()->firstOrCreate(
        ...
        $college = OnboardingFeature::query()->firstOrCreate(
        ...
        // Purge stored Pennant values so TESDA enrollment resolves freshly
        $tesdaClass = FeatureClassRegistry::classForKey($tesda->feature_key);
        if ($tesdaClass) {
            Feature::purge($tesdaClass);
        }
    }
