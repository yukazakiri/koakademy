...
export function AdminHeader({ title, user }: AdminHeaderProps) {
    ...
    return (
        <header className="mt-4 flex h-(--header-height) shrink-0 items-center gap-2 border-b pb-3 text-foreground transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
