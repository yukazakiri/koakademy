                ...
                <TabsContent value="documents">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Manage required files{flags.studentSignaturePad ? " and capture the student signature" : ""}.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                                <Card className="dark:to-background border-blue-100 bg-gradient-to-br from-blue-50 to-white shadow-sm transition-shadow hover:shadow-md dark:border-blue-900 dark:from-blue-950/20">
                                    <CardContent className="p-6">
                                        <div className="flex items-start justify-between">
                                            <div>
                                                <p className="mb-1 text-sm font-medium text-blue-600 dark:text-blue-400">Total Assessment</p>
                                        ...
                                        <div className="text-muted-foreground mt-4 flex items-center gap-1 text-xs">
                                            <span className="text-foreground font-medium">{student.tuition.total_tuition}</span> tuition + misc fees
                                        </div>
                                    </CardContent>
                                </Card>
                                ...
                                <Card className="dark:to-background border-green-100 bg-gradient-to-br from-green-50 to-white shadow-sm transition-shadow hover:shadow-md dark:border-green-900 dark:from-green-950/20">
                                    <CardContent className="p-6">
                                        <div className="flex items-start justify-between">
                                            <div>
                                                <p className="mb-1 text-sm font-medium text-green-600 dark:text-green-400">Total Paid</p>
                                                <h4 className="text-foreground text-3xl font-bold tracking-tight">{student.tuition.total_paid}</h4>
                                            </div>
                                ...
                                <Card className="dark:to-background border-amber-100 bg-gradient-to-br from-amber-50 to-white shadow-sm transition-shadow hover:shadow-md dark:border-amber-900 dark:from-amber-950/20">
                                    <CardContent className="p-6">
                                        <div className="flex items-start justify-between">
                                            <div>
                                                <p className="mb-1 text-sm font-medium text-amber-600 dark:text-amber-400">Balance Due</p>
                                                <h4 className="text-foreground text-3xl font-bold tracking-tight">{student.tuition.total_balance}</h4>
                                            </div>
                                                    ...
                                                    <PieChart>
                                                        <Pie
                                                            data={[
                                                                {
                                                                    name: "Lecture",
                                                                    value: parseFloat(student.tuition.total_lectures.replace(/[^0-9.-]+/g, "")),
                                                                },
                                                                {
                                                                    name: "Laboratory",
                                                                    value: parseFloat(student.tuition.total_laboratory.replace(/[^0-9.-]+/g, "")),
                                                                },
                                                                {
                                                                    name: "Misc",
                                                                    value: parseFloat(
                                                                        student.tuition.total_miscelaneous_fees.replace(/[^0-9.-]+/g, ""),
                                                                    ),
                                                                },
                                                            ]}
                                                            cx="50%"
                                                        ...
                                                        <TableBody>
                                                            ...
                                                            {student.tuition.discount !== "0%" && (
                                                                <TableRow className="text-green-600 hover:bg-transparent">
                                                                    ...
                                                                    <TableCell className="py-2 pr-0 text-right font-mono">- Applied</TableCell>
                                                                </TableRow>
                                                            )}
                                            ...
                                            <AccordionItem value="payment" className="border-b-0">
                                                ...
                                                <AccordionContent className="px-6 pb-4">
                                                    <div className="grid grid-cols-2 gap-4 pt-2">
                                                        <div className="space-y-1">
                                                            <p className="text-muted-foreground text-xs tracking-wider uppercase">Downpayment</p>
                                                            <p className="font-medium">{student.tuition.downpayment}</p>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <p className="text-muted-foreground text-xs tracking-wider uppercase">Payment Status</p>
                                                            <Badge
                                                                variant="outline"
                                                                className={
                                                                    student.tuition.total_balance === zeroString
                                                        ...
                                                        <div className="space-y-1">
                                                            <p className="text-muted-foreground text-xs tracking-wider uppercase">Academic Year</p>
                                                            <p className="font-medium">Year {student.tuition.academic_year}</p>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <p className="text-muted-foreground text-xs tracking-wider uppercase">Last Updated</p>
                                ...
                                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground mt-1 text-sm">
                                            No tuition record exists for the current academic period ({student.current_school_year} • Semester{" "}
                                            {student.current_semester}).
                                        </p>
                                    </div>
                                    <Link href={route("administrators.students.edit", student.id)} className={buttonVariants({ variant: "outline" })}>
