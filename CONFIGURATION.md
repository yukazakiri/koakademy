...
| --- | --- | --- |
| `KOAKADEMY_VERSION` | Latest stable GitHub tag | Pin an exact stable KoAkademy image tag. Explicit `edge` is accepted only for unsupported rolling evaluation. |
