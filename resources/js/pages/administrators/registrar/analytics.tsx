...
type Props = {
    ...
    report: { label: string; values: FilterValues; options: Record<string, Option[]>; context: { filters: { label: string; value: string }[]; status_rule: string; form_bc_rule: string } };
    generatedAt: string;
};
