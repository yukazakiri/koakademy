...
For example, installing standalone modules such as Forms or HR Management from the application repository is:

```sh
composer require koakademy/forms:^1.0
# or for HR Management:
# composer require koakademy/hr-management:^1.0
