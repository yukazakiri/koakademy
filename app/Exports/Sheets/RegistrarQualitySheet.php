...
final readonly class RegistrarQualitySheet implements FromArray, ShouldAutoSize, WithEvents, WithHeadings, WithStyles, WithTitle
{
    ...
    public function array(): array
    {
        ...
        return [
            ...
            ['Programs Missing Commission on Higher Education Form B/C Metadata', $q['missing_program_metadata_count'] ?? 0, ($q['missing_program_metadata_count'] ?? 0) > 0 ? '⚠ Needs Attention' : '✓ OK'],
