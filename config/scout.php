    ...
    'meilisearch' => [
        ...
        'index-settings' => [
            App\Models\User::class => [
                'filterableAttributes' => ['id', 'name', 'email', '__soft_deleted'],
            ],
            App\Models\Student::class => [
                'filterableAttributes' => ['__soft_deleted'],
                'searchableAttributes' => ['id', 'student_id', 'full_name', 'first_name', 'last_name', 'middle_name', 'email', 'lrn', 'course_code', 'course_title'],
            ],
            App\Models\Faculty::class => [
                'filterableAttributes' => ['__soft_deleted'],
                'searchableAttributes' => ['id', 'first_name', 'last_name', 'middle_name', 'email', 'department'],
            ],
