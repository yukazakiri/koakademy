...
export default function AnnouncementIndex({ user, announcements }: { user: User; announcements: PaginatedData<Announcement> }) {
    ...
    const handleDelete = (id: number) => {
        if (confirm("Are you sure you want to delete this announcement?")) {
            destroy(route("administrators.announcements.destroy", id), {
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Select value={data.priority} onValueChange={(v) => setData("priority", v as AnnouncementPriority)}>
                                        <SelectTrigger>
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div className="grid gap-2">
                                    ...
                                    <Select value={data.display_mode} onValueChange={(v) => setData("display_mode", v as AnnouncementDisplayMode)}>
                                        <SelectTrigger>
