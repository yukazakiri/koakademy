...
final class CGCurriculumSeeder extends Seeder
{
    public function run(): void
    {
        // Create or update TVL track
        $tvlTrack = ShsTrack::updateOrCreate(
            ['track_name' => 'TVL'],
            ['description' => 'Technical-Vocational-Livelihood Track']
        );

        // Create or update Caregiving strand
        $caregivingStrand = ShsStrand::updateOrCreate(
            [
                'strand_name' => 'Caregiving',
                'track_id' => $tvlTrack->id,
            ],
            ['description' => 'Caregiving Strand']
        );

        // Define all TVL subjects
        $subjects = [
            ...
            ['title' => 'Caregiving NC II - 1', 'grade_year' => 11, 'semester' => 1, 'category' => 'SPECIALIZED'],
            ...
            ['title' => 'Caregiving NC II - 2', 'grade_year' => 11, 'semester' => 2, 'category' => 'SPECIALIZED'],
            ...
            ['title' => 'Caregiving NC II - 3', 'grade_year' => 12, 'semester' => 1, 'category' => 'SPECIALIZED'],
            ...
            ['title' => 'Caregiving NC II - 4', 'grade_year' => 12, 'semester' => 2, 'category' => 'SPECIALIZED'],
        ];
        ...
        foreach ($subjects as $subject) {
            ...
            $subjectData = [
                ...
                'strand_id' => $caregivingStrand->id,
            ];

            StrandSubject::create($subjectData);
        }

        $this->command->info('TVL (Caregiving) curriculum seeded successfully!');
        $this->command->info("- Track: {$tvlTrack->track_name} (ID: {$tvlTrack->id})");
        $this->command->info("- Strand: {$caregivingStrand->strand_name} (ID: {$caregivingStrand->id})");
