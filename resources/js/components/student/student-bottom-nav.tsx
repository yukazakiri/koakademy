                ...
                {resolvedUser ? (
                    <DrawerContent className="z-[100] h-[85vh] max-h-[85vh] rounded-t-[2rem] px-0 pt-0 outline-none">
                        ...
                        <DrawerDescription className="sr-only">
                            Find enrolled classes, subjects, courses, and student enrollment records in one place.
                        </DrawerDescription>
                        <div className="flex h-full flex-1 overflow-hidden p-2">
                            <Command className="h-full flex-1 border-none bg-transparent" shouldFilter={false}>
                                <GlobalCommandContent
                                    ...
                                    searchPlaceholder="Search classes, subjects, courses, or enrolled data..."
                            ...
                            {studentBottomNavItems.map((item) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            {item.title === "Dashboard" ? "Home" : item.title}
                                        </span>
