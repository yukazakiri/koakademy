...
final class AdministratorCurriculumManagementController extends Controller
{
    ...
    private function programFormPayload(Course $course): array
    {
        return [
            ...
            'ched_reporting_level' => $course->ched_reporting_level,
            'ched_program_code' => $course->ched_program_code,
            'ched_major_code' => $course->ched_major_code,
            'ched_year_implemented' => $course->ched_year_implemented,
            'ched_other_delivery_mode' => $course->ched_other_delivery_mode,
